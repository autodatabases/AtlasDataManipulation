...
// Запрос на добавление lineage для данных
curl -u admin:admin   -H 'Content-Type:application/json'   -H 'Accept:application/json' http://localhost:21000/api/atlas/v2/entity/bulk -d '
  {"entities": [
    {
      "typeName": "'"etl_load_1"'",
      "createdBy": "'"etl_load_1"'_'"111"'_'"222"'",
      "attributes": {
        "qualifiedName": "'"hive_table"'-to-'"db_table"'",
        "name": "'"raw"'-to-'"clean"'",
        "description": "ingests '"raw"' to '"clean"'",
        "owner": "'"sh4dowauthor"'",
        "path":"/your/path/to/smth",
        "inputs": [{"guid": "'"ea05d4e2-16c7-4d2f-a68e-409967abbcde"'", "typeName": "'"hive_table"'"}],
        "outputs": [{"guid": "'"c90fca1e-90d3-45fb-b6c7-c0423b88c059"'","typeName": "'"db_table"'"}]
      
      }
    }
  ],
      "classifications": [
        { "typeName": "'"etl_db_load"'" }
      ]
    }
  ]
  }'
...
hive table guid ea05d4e2-16c7-4d2f-a68e-409967abbcde
db_table guid c90fca1e-90d3-45fb-b6c7-c0423b88c059
